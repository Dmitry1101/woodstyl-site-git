...
<div class="mainn">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					...
					<!-- <div class="bd-test">
						<div class="bd-test__wrapp">
							<div class="bd-test__over"></div>
																
						</div>
					</div> -->

					<div class="m-slider__wrapp">
						<div class="m-slider__control m-slider__prev with-ic-hover"><i class="icon icon-prevv"></i><i class="icon icon-prevv-h"></i></div>
						<div class="m-slider__control m-slider__next with-ic-hover"><i class="icon icon-nexxt"></i><i class="icon icon-nexxt-h"></i></div>
	...
	<div class="feat s content">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="sect-title txt-cent c-bwn">
						НАШИ ПРЕИМУЩЕСТВА
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-3">
					<div class="feat__it">
						...
						<div class="feat__txt">
							<p>
								<b>Стелажи и полки, Обеденные группы</b>
							</p>
							<p>
								Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							</p>
	...
	<div class="badv s">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6">
					<div class="blck badv__blck clearfix">
						<div class="txt-blck-2 fl-rght">
							<ul class="gall__cat">
								<li><a class="akktiff" href="#">Все</a></li>
							...
							<div class="clearfix">
								<a class="badv__more with-ic-hover"><i class="icon icon-nexxt2"></i><i class="icon icon-nexxt-h"></i></a>											
							</div>
